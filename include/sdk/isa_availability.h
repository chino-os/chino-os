...
enum ISA_AVAILABILITY {
    ...
    __ISA_AVAILABLE_NEON_ARM64 = 2, // support for 128-bit NEON instructions for ARM64. The distinction between ARM32
                                    // and ARM64 NEON is temporary. They may eventually be merged.
};
