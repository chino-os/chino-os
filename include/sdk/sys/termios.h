...
#define TCSAFLUSH                                                                                                      \
    2 /* Change attributes when output has drained;                                                                    \
...
#define TCIOFLUSH                                                                                                      \
    2 /* Flush both pending input and untransmitted                                                                    \
       * output */
...
#define TCIOFF                                                                                                         \
    2 /* Transmit a STOP character, intended to                                                                        \
       * suspend input data */
#define TCION                                                                                                          \
    3 /* Transmit a START character, intended to                                                                       \
       * restart input data */
