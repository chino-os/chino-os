...
void Chino::Memory::BSPInitializeHeap(const BootParameters& bootParams) noexcept
{
...
void* Chino::Memory::BSPHeapAlloc(size_t wantedSize) noexcept
{
...
void Chino::Memory::BSPHeapFree(void* ptr) noexcept
{
...
size_t Chino::Memory::BSPGetFreeBytesRemaining()
{
