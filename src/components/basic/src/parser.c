...
static int str_mid(basic_type *str, basic_type *start, basic_type *length, basic_type *rv) {
    ...
    if (length->empty) {
        ...
        if (_length + _start > strlen(source))
            _length = strlen(source) - _start;
    }
...
token register_function_0(basic_function_type type, char *keyword, function_0 function) {
    ...
    basic_function bf = {.token = t, .type = type, .nr_arguments = 0, .function.function_0 = function};
...
token register_function_1(basic_function_type type, char *keyword, function_1 function, kind v1) {
    token t = register_token(keyword);
    basic_function bf = {.token = t, .type = type, .nr_arguments = 1, .kind_1 = v1, .function.function_1 = function};
...
token register_function_2(basic_function_type type, char *keyword, function_2 function, kind v1, kind v2) {
    token t = register_token(keyword);
    basic_function bf = {
        .token = t, .type = type, .nr_arguments = 2, .kind_1 = v1, .kind_2 = v2, .function.function_2 = function};
...
token register_function_4(basic_function_type type, char *keyword, function_4 function, kind v1, kind v2, kind v3,
                          kind v4) {
    token t = register_token(keyword);
    basic_function bf = {.token = t,
                         .type = type,
...
token register_function_5(basic_function_type type, char *keyword, function_5 function, kind v1, kind v2, kind v3,
                          kind v4, kind v5) {
    token t = register_token(keyword);
    basic_function bf = {.token = t,
                         .type = type,
