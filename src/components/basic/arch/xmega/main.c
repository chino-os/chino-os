...
int uart_fgetc(FILE *stream) { return keyboard_getc(); }
...
static int do_joystick(basic_type *rv) {
    rv->kind = kind_numeric;
    rv->value.number = joystick_read_stick();
    return 0;
}

static int do_button(basic_type *rv) {
    rv->kind = kind_numeric;
    rv->value.number = joystick_read_button();
    return 0;
}

static int do_led(basic_type *status, basic_type *rv) {
...
static int do_sound(basic_type *freq, basic_type *duration, basic_type *rv) {
...
static int do_plot(basic_type *x, basic_type *y, basic_type *code, basic_type *rv) {
...
static int do_defchar(basic_type *code, basic_type *definition, basic_type *rv) {
...
static int do_cursor(basic_type *cursor, basic_type *rv) {
...
static int do_charat(basic_type *x, basic_type *y, basic_type *rv) {
...
static int do_fontbank(basic_type *p1, basic_type *p2, basic_type *rv) {
...
static int do_gfx(basic_type *gfx, basic_type *rv) {
...
static int do_hplot(basic_type *_x, basic_type *_y, basic_type *_set, basic_type *rv) {
...
static int do_overflow(basic_type *overflow, basic_type *rv) {
...
static int do_invert(basic_type *invert, basic_type *rv) {
...
static int do_at(basic_type *x, basic_type *y, basic_type *rv) {
    rv->kind = kind_numeric;
    rv->value.number = 10;
...
static void batch(char *filename) {
    FIL fil;
    FRESULT fr;
...
static int do_batch(basic_type *rv) {
