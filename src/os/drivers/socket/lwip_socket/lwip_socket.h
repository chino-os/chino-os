...
class lwip_socket_device : public kernel::io::socket_device {
  public:
    constexpr lwip_socket_device(hal::meta::board_desc::chip::machine::devices::lwip_socket) noexcept {}
...
class lwip_socket_driver {
  public:
    template <class TDevice, class TBottomDevice> using device_t = lwip_socket_device;

    static result<void> install_device(lwip_socket_device &device) noexcept;
};
} // namespace chino::os::drivers
